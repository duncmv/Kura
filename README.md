...
1) **setup some packages**
	This can be done by running puppet file setup.pp
	```Bash
	sudo puppet apply setup.pp
	```

2) **start a new postgresql session**
	This can be done by running
	```Bash
	psql -U postgres -d postgres
	```

3) **create a new postgres user and database for kura**
	This can be done by running the following commands in postgres interactive mode:
	```postgres
...
4) **Create the tables for the database**
	This will be done by running create_tables.py file that contains the following
	```python
	...
	```
	This is better for creating the tables in order to avoid any conflect between the structure of tables from sqlalchemy and from SQL statements.

5) **Dump some data in the database**
	Start a new postgresql interactive session
	```Bash
	psql -U postgres -d postgres
	```
	...
	('Very Satisfied)', 'ef555d7c-c280-4b40-826d-8348fbedebf4', 'ed0dff3d-ea24-4953-8c7d-eb2bb379dbce', '2024-04-21 03:26:20.688034', '2024-04-21 03:26:20.688036'),
	('Satisfied', 'ef555d7c-c280-4b40-826d-8348fbedebf4', '20d3c432-9b6a-4065-a530-f0436fd4a447', '2024-04-21 03:26:20.688052', '2024-04-21 03:26:20.688053'),
	('Not sure', 'ef555d7c-c280-4b40-826d-8348fbedebf4', '5b2a0db4-2242-429f-9400-1566115479ed', '2024-04-21 03:26:20.688067', '2024-04-21 03:26:20.688069'),
...
## How to dump and retrieve data from the database
...
3) **Create a new poll**
	...
	Storage.new(Poll(
		...
		district_id="",
		ed_role="",
		endustry_of_interest="",
		occupation="",
		company_staff_only=False
	))
	Storage.save()
	```
	Another way
	...
	inst = Storage.get(Institution, "some_id")
	inst.polls.append(Poll(
		title="",
		description="",
		district_id="",
		ed_role="",
