...
const container = 'min-h-[83vh] md:max-h-[83vh] w-11/12 mx-auto flex flex-col justify-center overflow-hidden';
...
export { button, input, a, h2, h3, card, gap, container, form, formContainer };
